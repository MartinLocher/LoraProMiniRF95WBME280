...
static const u1_t DEVEUI[8]  = { 0x05, 0x04, 0x03, 0x02, 0x01, 0x00, 0x40, 0x88 };
...
static const u1_t APPKEY[16] = { 0xF1, 0xF0, 0x30, 0x0E, 0xCE, 0xCB, 0x3A, 0xCB, 0x9A, 0x39, 0x89, 0xAE, 0xF5, 0xEC, 0xD1, 0xC8 };
